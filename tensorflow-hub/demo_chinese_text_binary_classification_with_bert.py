...
<<<<<<< HEAD
        # f1_score = tf.contrib.metrics.f1_score(       # multi-class not supported
=======
        # f1_score = tf.contrib.metrics.f1_score(
>>>>>>> f02a82c09e28fcfbf3dcffa8a81483bed5716ebf
        #     label_ids,
        #     predicted_labels)
        # auc = tf.metrics.auc(
        #     label_ids,
...
myparam = {
        ...
        "LEARNING_RATE": 2e-5,
        "NUM_TRAIN_EPOCHS":3,
        "bert_model_hub": "moduleA/"          # "https://tfhub.dev/google/bert_chinese_L-12_H-768_A-12/1"
    }
